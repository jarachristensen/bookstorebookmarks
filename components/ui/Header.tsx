  ...
  return (
    <header className="relative z-30 border-b border-[#E8E2D5] bg-[#FAF8F5]/95 backdrop-blur-xs transition-all shadow-2xs sticky top-0">
      <div className="max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="group inline-flex items-center gap-2 select-none shrink-0">
          <div className="flex items-center">
            <span className="font-serif font-black text-base sm:text-lg md:text-xl tracking-tight">
              <span className="text-[#F43F7A]">The</span>{" "}
              <span className="text-[#2563EB]">Bookstore</span>{" "}
              <span className="text-[#F43F7A]">Bookmark</span>{" "}
              <span className="text-[#2563EB]">Archive</span>
            </span>
          </div>
        </Link>
